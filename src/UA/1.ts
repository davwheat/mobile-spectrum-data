...
const data: SpectrumBlock[] = [
  ...
  },
  {
    ...
    uarfcns: [10662],
    details: [
      "UMTS B1 5 MHz everywhere outside of Kyiv",
      "This 5 MHz lot was purchased by Kyivstar on the spectrum auction on 19.11.2024 but is still operated by Vodafone",
    ],
  },
  {
    owner: "Kyivstar",
