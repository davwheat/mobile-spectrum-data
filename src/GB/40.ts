...
const data: SpectrumBlock[] = [
  ...
  },
  {
    ...
    type: "tdd",
    details: [
      "Spectrum earmarked for use within the Emergency Services Network.",
    ],
    sourceInfo: {
      type: "url",
  ...
  },
  {
    ...
    type: "generic",
    details: [
      "Vehicle-mounted gateway small cells for Emergency Services Network are being considered for use within this spectrum.",
    ],
    sourceInfo: {
      type: "url",
      url: "https://static.ofcom.org.uk/static/spectrum/map.html",
